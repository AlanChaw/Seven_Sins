...
ansible-playbook -i inventory.ini -u ubuntu --key-file=./Group58 -v docker-configuration.yml
...
ansible-playbook -i inventory.ini -u ubuntu --key-file=./Group58 -v couchdb-cluster-setup.yml

# setup the web server and load the data
ansible-playbook -i inventory.ini -u ubuntu --key-file=./Group58 -v background-configuration.yml
