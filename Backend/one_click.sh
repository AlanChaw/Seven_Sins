...
{
  curl -X POST -H 'Content-Type: application/json' -d '{"source":"http://admin:123456@115.146.92.183:5984/food_twitters","target":"http://admin:123456@localhost:5984/food_twitters"}' http://admin:123456@localhost:5984/_replicate
  curl -X POST -H 'Content-Type: application/json' -d '{"source":"http://admin:123456@115.146.92.183:5984/shopping_twitters","target":"http://admin:123456@localhost:5984/shopping_twitters"}' http://admin:123456@localhost:5984/_replicate
  curl -X POST -H 'Content-Type: application/json' -d '{"source":"http://admin:123456@115.146.92.183:5984/job_twitters","target":"http://admin:123456@localhost:5984/job_twitters"}' http://admin:123456@localhost:5984/_replicate
} &> /dev/null
